...
import signinimage from "../../../SvgIcons/SignIn.svg";
import "../style.css";
...
const Login = () => {
  ...
  return (
    ...
    >
        ...
        <img src={signinimage} height="30%" width="20%" />
      ...
      <div className="w-full max-w-xs">
        ...
        >
          ...
          <button className="btn-primary btn mt-3" type="submit">
            Log In
          </button>
